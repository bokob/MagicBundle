...
public class PlayerParry : MonoBehaviour
{
    ...
    [SerializeField] Coroutine _parryCoroutine;
    [SerializeField] PlayerStatus _playerStatus;
    [SerializeField] Shouting _shouting;
    [SerializeField] PlayerText _playerText;
    [SerializeField] MagicBundle _magicBundle;
    ...
    void Start()
    {
        ...
        Managers.Input.parryStartAction += StartParryCoroutine;
        Managers.Input.parryEndAction += StopParry;
    }
